<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GoogleBarChart.ascx.cs" Inherits="Components_GoogleBarChart" %>
...
<asp:Literal ID="LitOpenScriptTag" runat="server"></asp:Literal>
    ...
    function drawChart<asp:Literal ID="Literal8" runat="server"></asp:Literal>() {
        ...
        var chart<asp:Literal ID="Literal10" runat="server"></asp:Literal> = new google.visualization.BarChart(document.getElementById('<asp:Literal ID="LitChartId" runat="server"></asp:Literal>'));
