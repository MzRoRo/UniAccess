...
public partial class Components_GoogleBarChart : System.Web.UI.UserControl
{
    ...
    public List<BarValue> rows { get; set; }

    public Components_GoogleBarChart()
    {
        rows = new List<BarValue>();
    }

    public Components_GoogleBarChart(string id, string column, string valuetitle, string title, int height, int width, List<BarValue> d)
    {
        rows = new List<BarValue>();
        rows = d;
        chartId = id;
    ...
    public class BarValue
    {
        ...
        public BarValue(string title, float value)
        {
            this.title = title;
            this.value = value;
        }
